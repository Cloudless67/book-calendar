...
const LoginModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-slate-900/80 backdrop-blur-md transition-opacity">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-ful
      
      l mx-4 text-center transform transition-all scale-100 opacity-100">
        
        {/* Logo or Icon */}
        <div className="mb-6 flex justify-center">
          <div className="w-20 h-20 bg-indigo-100 text-indigo-600 rounded-2xl flex items-center justify-center shadow-inner">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mb-2">나의 독서 대시보드</h2>
